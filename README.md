...
Show it on the [demo site](https://demo.akazie.com/peter-2025v2)

## Installation

1. From the root of your Grav installation, run `bin/gpm install peter-2025v2`.
   - Alternatively, download this repository, unzip it, rename the folder to `peter-2025v2`, and place it in the `user/themes/` directory of your Grav install
